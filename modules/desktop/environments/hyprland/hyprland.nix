...
in
{
  ...
  flake.modules.homeManager.desktop =
    ...
    }:
    {
      ...
      # To change wallpaper, you must use the Stylix module.
      ...
      services.hypridle = {
        ...
        settings = {
          general = {
            ...
            after-sleep = "hyprctl dispatch dpms on && systemctl --user restart hyprpaper";
          };
          listener = [
            {
              timeout = 150;
      ...
      programs.kitty.enable = true; # Kitty is the default terminal
      programs.satty.enable = true; # Satty is a Screenshot annotator
      ...
      wayland.windowManager.hyprland = {
        ...
        settings = {
          ...
          exec-once = [
            ...
            "uwsm app -- ${pkgs.hypridle}/libexec/hypridle"
